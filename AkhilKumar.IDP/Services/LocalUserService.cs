...
using AkhilKumar.IDP.Entities;
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;
using System.Security.Cryptography;

namespace AkhilKumar.IDP.Services
{
    public class LocalUserService : ILocalUserService
    {
          ...
          string password)
        {
            ...
            var varificationResult = _passwordHasher.
                VerifyHashedPassword(user, user.Password, password);

            return (varificationResult == PasswordVerificationResult.Success);
        }
